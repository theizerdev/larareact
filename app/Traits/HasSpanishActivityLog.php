...
trait HasSpanishActivityLog
{
    ...
    public static $fieldLabelsMap = [
        ...
        'cargo_id' => 'Cargo',
        'numero_orden' => 'N° de Orden',
        'cliente_nombre' => 'Nombre del Cliente',
        'cliente_telefono' => 'Teléfono del Cliente',
        'tipo_dispositivo' => 'Tipo de Dispositivo',
        'marca_nombre' => 'Marca',
        'modelo_nombre' => 'Modelo',
        'imei_serie' => 'IMEI / N° Serie',
        'descripcion_falla' => 'Falla reportada',
        'observaciones_fisicas' => 'Observaciones físicas',
        'contrasena_patron' => 'Clave / Patrón de desbloqueo',
