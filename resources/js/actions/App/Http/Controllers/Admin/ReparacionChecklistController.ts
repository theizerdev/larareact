...
/**
* @see \App\Http\Controllers\Admin\ReparacionChecklistController::indexPage
...
/**
* @see \App\Http\Controllers\Admin\ReparacionChecklistController::resetDefaults
* @see app/Http/Controllers/Admin/ReparacionChecklistController.php:240
* @route '/admin/reparaciones/checklist/reset-defaults'
*/
export const resetDefaults = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: resetDefaults.url(options),
    method: 'post',
})

resetDefaults.definition = {
    methods: ["post"],
...
* @route '/admin/reparaciones/checklist/reset-defaults'
*/
resetDefaults.url = (options?: RouteQueryOptions) => {
    return resetDefaults.definition.url + queryParams(options)
}
...
* @route '/admin/reparaciones/checklist/reset-defaults'
*/
resetDefaults.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: resetDefaults.url(options),
    method: 'post',
})
...
const ReparacionChecklistController = { indexPage, index, store, update, destroy, reorder, batchToggle, duplicate, resetDefaults, copyToBranch }

export default ReparacionChecklistController