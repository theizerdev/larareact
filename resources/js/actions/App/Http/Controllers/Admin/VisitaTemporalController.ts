...
/**
* @see \App\Http\Controllers\Admin\VisitaTemporalController::generatePreRegistro
...
/**
* @see \App\Http\Controllers\Admin\VisitaTemporalController::storeTipoServicio
 * @see app/Http/Controllers/Admin/VisitaTemporalController.php:411
 * @route '/admin/tipo-servicios'
 */
export const storeTipoServicio = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeTipoServicio.url(options),
    method: 'post',
})
 ...
 * @route '/admin/tipo-servicios'
 */
storeTipoServicio.url = (options?: RouteQueryOptions) => {
    return storeTipoServicio.definition.url + queryParams(options)
}
 ...
 * @route '/admin/tipo-servicios'
 */
storeTipoServicio.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeTipoServicio.url(options),
    method: 'post',
})
 ...
 * @route '/admin/tipo-servicios'
 */
    const storeTipoServicioForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: storeTipoServicio.url(options),
        method: 'post',
    })
 ...
 * @route '/admin/tipo-servicios'
 */
        storeTipoServicioForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: storeTipoServicio.url(options),
            method: 'post',
        })
...
const VisitaTemporalController = { index, store, generatePreRegistro, storeTipoServicio, update, toggleStatus, destroy }

export default VisitaTemporalController