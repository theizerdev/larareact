...
/**
* @see \App\Http\Controllers\Admin\PointOfSale\ClienteController::abono
* @see app/Http/Controllers/Admin/PointOfSale/ClienteController.php:113
* @route '/admin/clientes/{cliente}/abono'
*/
export const abono = (args: { cliente: number | { id: number } } | [cliente: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: abono.url(args, options),
    method: 'post',
})
...
* @route '/admin/clientes/{cliente}/abono'
*/
abono.url = (args: { cliente: number | { id: number } } | [cliente: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { cliente: args }
    }
...
* @route '/admin/clientes/{cliente}/abono'
*/
abono.post = (args: { cliente: number | { id: number } } | [cliente: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: abono.url(args, options),
    method: 'post',
})
...
const clientes = {
    ...
    abono: Object.assign(abono, abono),
}
