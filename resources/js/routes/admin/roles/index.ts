...
* @see app/Http/Controllers/Admin/RoleController.php:140
* @route '/admin/roles'
*/
...
* @see app/Http/Controllers/Admin/RoleController.php:177
...
* @see app/Http/Controllers/Admin/RoleController.php:219
* @route '/admin/roles/{role}'
*/
