            ...
            <div className="w-full bg-white dark:bg-slate-950 py-3 border-b border-slate-100 dark:border-slate-800/20">
                <div className="max-w-4xl mx-auto px-6">
                    <div className="flex items-center justify-between text-xs font-semibold text-slate-500 dark:text-slate-400">
                        ...
                        <ChevronRight className="w-3 h-3 text-slate-400" />
                        <span className={cn(step >= 3 && "text-emerald-600 dark:text-emerald-400")}>{__('3. Summary')}</span>
                    </div>
                    <div className="w-full bg-slate-200 dark:bg-slate-800 h-1.5 rounded-full mt-2 overflow-hidden">
                        <div className="bg-emerald-600 dark:bg-emerald-400 h-full transition-all duration-300" style={{ width: `${(step / 3) * 100}%` }}></div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div className="flex gap-2">
                                        <div className="flex-1">
                                            <Select 
                                                ...
                                                onValueChange={(v) => setProfileData(p => ({ ...p, tipo_servicio_id: v }))}
                                            >
