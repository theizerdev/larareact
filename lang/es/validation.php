...
return [
    ...
    */
    ...
    'custom' => [
        'logo' => [
            'max' => 'El logo principal no debe ser mayor a :max kilobytes (5 MB).',
            'mimes' => 'El logo principal debe ser una imagen JPEG, PNG o WEBP.',
            'image' => 'El logo principal debe ser una imagen válida.',
        ],
        'logo_mini' => [
            'max' => 'El logo mini (favicon) no debe ser mayor a :max kilobytes (2 MB).',
            'mimes' => 'El logo mini debe ser una imagen JPEG, PNG o WEBP.',
            'image' => 'El logo mini debe ser una imagen válida.',
        ],
    ],
