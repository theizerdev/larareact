...
use App\Http\Controllers\Admin\ProveedorVehiculoController;
...
Route::middleware(['permission:proveedores.view'])->group(function () {
    ...
    Route::get('/proveedores/{proveedor}/vehiculos', [ProveedorVehiculoController::class, 'index']);
});
...
Route::middleware(['permission:proveedores.edit'])->group(function () {
    ...
    Route::post('/proveedor-vehiculos/{id}', [ProveedorVehiculoController::class, 'update']);
});
...
Route::middleware(['permission:proveedores.delete'])->group(function () {
    ...
    Route::delete('/proveedor-vehiculos/{id}', [ProveedorVehiculoController::class, 'destroy']);
});
